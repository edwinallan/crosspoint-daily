...
enum class HomeMenuItem { NONE, BIBLE, FILE_BROWSER, RECENTS, OPDS_BROWSER, FILE_TRANSFER, SETTINGS_MENU };
...
class ActivityManager {
 ...
 public:
  ...
  void goToBible(bool resumeFromSleep = false);
  void goToSettings();
